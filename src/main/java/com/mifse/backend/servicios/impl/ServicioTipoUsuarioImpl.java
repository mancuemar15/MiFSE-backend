...
import com.mifse.backend.excepciones.TipoUsuarioNotFoundException;
...
public class ServicioTipoUsuarioImpl implements ServicioTipoUsuario {
	...
	public TipoUsuario obtenerPorTipo(String tipo) {
		return this.repositorioTipoUsuario.findByTipo(tipo).orElseThrow(() -> new TipoUsuarioNotFoundException(tipo));
	}
